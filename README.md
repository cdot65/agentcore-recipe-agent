...
**[Documentation](https://cdot65.github.io/aws-bedrock-agentcore-typescript-example/)**
...
Full docs at **[cdot65.github.io/aws-bedrock-agentcore-typescript-example](https://cdot65.github.io/aws-bedrock-agentcore-typescript-example/)**:

- [Getting Started](https://cdot65.github.io/aws-bedrock-agentcore-typescript-example/getting-started/quick-start/) — prerequisites, setup, configuration
- [Architecture](https://cdot65.github.io/aws-bedrock-agentcore-typescript-example/architecture/overview/) — system diagrams, request flow, design decisions
- [Deployment Guide](https://cdot65.github.io/aws-bedrock-agentcore-typescript-example/deployment-guide/01-introduction-and-prerequisites/) — Docker, AWS infra, AgentCore, CI/CD
- [Reference](https://cdot65.github.io/aws-bedrock-agentcore-typescript-example/reference/response-schema/) — response schema, env vars, dependencies
